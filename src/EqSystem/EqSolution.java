...
public class EqSolution {
    private  double[][] calculateByGauss(double[][] matrix, double[] results) {
    ...
    public double[] getResult(double[][] matrix, double[] results) {
        double[][] triangle = calculateByGauss(matrix, results);
    ...
    private double[][] createFullMatrix(double[][] matrix, double[] result) {
    ...
    public boolean isnNullRow(double[] row) {
